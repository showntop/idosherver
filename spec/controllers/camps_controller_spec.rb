...
RSpec.describe CampsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all camps as @camps" do
      ...
      expect(assigns(:camps)).to eq([camp])
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new camp as @camp" do
      ...
      expect(assigns(:camp)).to be_a_new(Camp)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created camp as @camp" do
        post :create, {:camp => valid_attributes}, valid_session
        expect(assigns(:camp)).to be_a(Camp)
        expect(assigns(:camp)).to be_persisted
      end

      it "redirects to the created camp" do
        post :create, {:camp => valid_attributes}, valid_session
        expect(response).to redirect_to(Camp.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved camp as @camp" do
        post :create, {:camp => invalid_attributes}, valid_session
        expect(assigns(:camp)).to be_a_new(Camp)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested camp" do
        camp = Camp.create! valid_attributes
        put :update, {:id => camp.to_param, :camp => new_attributes}, valid_session
        camp.reload
      ...
      it "redirects to the camp" do
        camp = Camp.create! valid_attributes
        put :update, {:id => camp.to_param, :camp => valid_attributes}, valid_session
        expect(response).to redirect_to(camp)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the camp as @camp" do
        camp = Camp.create! valid_attributes
        put :update, {:id => camp.to_param, :camp => invalid_attributes}, valid_session
        expect(assigns(:camp)).to eq(camp)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the camps list" do
      camp = Camp.create! valid_attributes
      delete :destroy, {:id => camp.to_param}, valid_session
      expect(response).to redirect_to(camps_url)
    end
  end
